...
Question generateQuestion(int level, mt19937& gen) {
    ...
    switch (level) {
        case 1: maxNum = 9; break;    // Single digit
        case 2: maxNum = 99; break;   // Two digits
        case 3: maxNum = 999; break;  // Three digits
        default: maxNum = 9;
    }
    ...
    int op = op_dist(gen);
    switch (op) {
        case 0: q.operation = '+'; break;
        case 1: q.operation = '-'; break;
        case 2: q.operation = '*'; break;
    }
